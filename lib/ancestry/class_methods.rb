module Ancestry
  module ClassMethods
    ...
    def build_ancestry_from_parent_ids! client_id = nil, parent_id = nil, ancestry = nil
      self.ancestry_base_class.unscoped do
        self.ancestry_base_class.where(:client_id => client_id, :parent_id => parent_id).find_each do |node|
          node.without_ancestry_callbacks do
